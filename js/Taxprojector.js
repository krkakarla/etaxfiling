...
/* else
 ...
 -----Below details -----
        ...
        tax_amt = (Taxamountold - 250000) * 0.05 - 12500;
    }
};*/
...
function TAXCAL() {
    ...
    else if (tax_amt >= 0) { tax_amt = tax_amt; }
    ...
    else if (Taxamountnew >= 800001 && Taxamountnew <= 1200000) { tax_amt2 = 20000 + 0.10 * (Taxamountnew - 800000) - 60000; }
    else if (Taxamountnew >= 400001 && Taxamountnew <= 800000) { tax_amt2 = 0 + 0.05 * (Taxamountnew - 400000) - 60000; }
    else (tax_amt2 = 0);

    if (tax_amt2 < 0) tax_amt2 = 0;
    else if (tax_amt2 > 0) { tax_amt2 = tax_amt2; }
